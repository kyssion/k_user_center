...
GRANT EXECUTE ON FUNCTION core.fn_hash_jsonb(jsonb) TO kuc_app, kuc_authn_writer, kuc_control_writer;
...
SET ROLE kuc_owner;
SELECT core.fn_register_migration('080', '统一对象所有者、显式最小权限与职责分离角色', NULLIF(current_setting('kuc.migration_sha256', true), ''));
RESET ROLE;
COMMIT;
