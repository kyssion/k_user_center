...
- 非数据库职责：引用存在性、租户一致性、状态转换、最终用户/管理员授权、数据范围、领域 Owner、风险、审批、加密、协议、幂等语义、流程和删除编排；具体实现以后续代码实施文档为准。
...
4. 进入编码阶段后，按单独的代码实施文档执行状态机属性测试、逻辑引用负向测试、业务授权/数据范围测试、领域 Owner 越权测试、租户隔离测试、追加/不可变历史篡改测试和敏感日志扫描。
