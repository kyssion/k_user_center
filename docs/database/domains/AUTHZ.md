...
- 持久化范围：`permissions`、`roles`、`role_permissions`、`user_role_assignments`、`group_role_assignments`、`machine_role_assignments`、`data_scope_definitions`、`policy_versions`、`policy_bindings`、`authorization_decisions`、`authorization_decision_policy_versions`、`relationship_tuples`。
