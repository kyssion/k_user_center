...
- `authz.role_exclusion`
- `authz.role_assignment`
- `authz.policy_release`
- `authz.obligation_type`
- `authz.pep_capability`
- `authz.authorization_decision`
- `authz.relationship_tuple`
- `authz.access_review`
- `authz.permission_simulation`
