...
- `privacy.purpose`
- `privacy.data_category`
- `privacy.purpose_data_mapping`
- `privacy.agreement`
- `privacy.agreement_acceptance`
- `privacy.consent_aggregate`
- `privacy.consent`
- `privacy.marketing_subscription`
- `privacy.privacy_request`
- `privacy.privacy_request_task`
- `privacy.legal_hold`
- `privacy.export_job`
- `privacy.retention_rule`
- `privacy.deletion_proof`
- `privacy.cross_border_authorization`
- `privacy.minor_protection`
...
- 跨域依赖：`assurance`、`authn`、`control`、`iam`、`oauth`、`org`；所有 Schema 的 `build.sql` 完成后再执行本模块 `links.sql`。
