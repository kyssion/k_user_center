...
- 数据库模型是否足以支撑业务要求见 [`database/业务模型与持久化边界清单.md`](./database/业务模型与持久化边界清单.md)。命令事务、参数与逻辑引用校验、业务权限、错误映射和测试边界见 [`implementation/README.md`](./implementation/README.md)；具体代码目录、类、接口和框架用法不属于数据库文档范围。
