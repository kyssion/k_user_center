...
WITH seed(id, event_type, json_schema) AS (
    VALUES
        ...
        ('50000000-0000-0000-0000-000000000002'::uuid, 'user.lifecycle.changed', '{"type":"object","properties":{"previous_state":{"type":"string"},"current_state":{"type":"string"},"reason_code":{"type":["string","null"]}},"required":["previous_state","current_state"],"additionalProperties":false}'::jsonb),
        ('50000000-0000-0000-0000-000000000003'::uuid, 'user.security_state.changed', '{"type":"object","properties":{"dimension":{"type":"string","enum":["authentication_lock","security_freeze"]},"previous_state":{"type":"string"},"current_state":{"type":"string"},"security_epoch":{"type":"integer","minimum":0}},"required":["dimension","previous_state","current_state","security_epoch"],"additionalProperties":false}'::jsonb),
        ...
        ('50000000-0000-0000-0000-000000000006'::uuid, 'user.merge.completed', '{"type":"object","properties":{"operation_id":{"type":"string","format":"uuid"},"source_user_id":{"type":"string","format":"uuid"},"canonical_user_id":{"type":"string","format":"uuid"}},"required":["operation_id","source_user_id","canonical_user_id"],"additionalProperties":false}'::jsonb),
        ...
        ('50000000-0000-0000-0000-000000000019'::uuid, 'identifier.verified', '{"type":"object","properties":{"binding_id":{"type":"string","format":"uuid"},"identifier_type":{"type":"string"},"verified_at":{"type":"string","format":"date-time"}},"required":["binding_id","identifier_type","verified_at"],"additionalProperties":false}'::jsonb),
        ('50000000-0000-0000-0000-000000000020'::uuid, 'identifier.reassigned', '{"type":"object","properties":{"identifier_type":{"type":"string"},"previous_binding_id":{"type":"string","format":"uuid"},"current_binding_id":{"type":"string","format":"uuid"},"protection_until":{"type":["string","null"],"format":"date-time"}},"required":["identifier_type","previous_binding_id","current_binding_id"],"additionalProperties":false}'::jsonb),
        ('50000000-0000-0000-0000-000000000021'::uuid, 'user.merge.started', '{"type":"object","properties":{"operation_id":{"type":"string","format":"uuid"},"source_user_id":{"type":"string","format":"uuid"},"canonical_user_id":{"type":"string","format":"uuid"}},"required":["operation_id","source_user_id","canonical_user_id"],"additionalProperties":false}'::jsonb),
        ('50000000-0000-0000-0000-000000000022'::uuid, 'user.merge.failed', '{"type":"object","properties":{"operation_id":{"type":"string","format":"uuid"},"source_user_id":{"type":"string","format":"uuid"},"canonical_user_id":{"type":"string","format":"uuid"},"reason_code":{"type":"string"}},"required":["operation_id","source_user_id","canonical_user_id","reason_code"],"additionalProperties":false}'::jsonb),
        ('50000000-0000-0000-0000-000000000023'::uuid, 'user.anonymized', '{"type":"object","properties":{"deletion_proof_id":{"type":"string","format":"uuid"},"reason_code":{"type":"string"}},"required":["deletion_proof_id","reason_code"],"additionalProperties":false}'::jsonb),
        ('50000000-0000-0000-0000-000000000024'::uuid, 'risk.detected', '{"type":"object","properties":{"assessment_id":{"type":"string","format":"uuid"},"risk_level":{"type":"string"},"disposition":{"type":"string"}},"required":["assessment_id","risk_level","disposition"],"additionalProperties":false}'::jsonb),
        ('50000000-0000-0000-0000-000000000025'::uuid, 'risk.disposition.changed', '{"type":"object","properties":{"assessment_id":{"type":"string","format":"uuid"},"previous_disposition":{"type":["string","null"]},"current_disposition":{"type":"string"}},"required":["assessment_id","current_disposition"],"additionalProperties":false}'::jsonb),
        ('50000000-0000-0000-0000-000000000026'::uuid, 'token.family.compromised', '{"type":"object","properties":{"token_family_id":{"type":"string","format":"uuid"},"reason_code":{"type":"string"},"revocation_watermark":{"type":["integer","null"],"minimum":0}},"required":["token_family_id","reason_code"],"additionalProperties":false}'::jsonb),
